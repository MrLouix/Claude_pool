...
```powershell
pip install --no-cache-dir claude_pool-1.2.2-py3-none-any.whl
```

> Si `pip` n'est pas reconnu, utilisez `python -m pip install --no-cache-dir claude_pool-1.2.2-py3-none-any.whl`

### Linux / macOS — Installation depuis la release

```bash
pip install claude_pool-1.2.2-py3-none-any.whl
```
...
pip install --no-cache-dir --force-reinstall claude_pool-1.2.2-py3-none-any.whl
...
pip install --force-reinstall claude_pool-1.2.2-py3-none-any.whl
